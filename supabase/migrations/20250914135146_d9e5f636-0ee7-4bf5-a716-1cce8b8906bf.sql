...
-- Add student info fields to quiz_attempts for anonymous access
ALTER TABLE public.quiz_attempts 
ALTER COLUMN student_name SET NOT NULL DEFAULT '',
ALTER COLUMN student_email SET NOT NULL DEFAULT '';
